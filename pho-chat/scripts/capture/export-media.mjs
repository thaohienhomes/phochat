...
// Map fragments in video filenames to desired output names
const mapping = [
  { match: "desktop-light-sidebar-history", out: "desktop-sidebar-history-light.gif" },
  { match: "desktop-dark-sidebar-history", out: "desktop-sidebar-history-dark.gif" },
  { match: "mobile-light-drawer-navigation", out: "mobile-drawer-navigation-light.gif" },
  { match: "mobile-dark-drawer-navigation", out: "mobile-drawer-navigation-dark.gif" },
  { match: "desktop-light-session-selection-autoscroll", out: "session-selection-autoscroll-light.gif" },
  { match: "desktop-dark-session-selection-autoscroll", out: "session-selection-autoscroll-dark.gif" },
  { match: "desktop-light-sidebar-toggle-responsive", out: "sidebar-toggle-responsive-light.gif" },
  { match: "desktop-dark-sidebar-toggle-responsive", out: "sidebar-toggle-responsive-dark.gif" },
];
